...
export const dataPresets = {
    'county_usfacts.geojson': {
        ...
        tables: {
            ...
            pct_parttime:{
                csv: 'mobility_parttime_workdays_safegraph',
                type: 'time-series',
                joinColumn: 'county',
                dateList: 'isoDateList'
            },
            pct_fulltime:{
                csv: 'mobility_fulltime_workdays_safegraph',
                type: 'time-series',
                joinColumn: 'county',
                dateList: 'isoDateList'
            },
    ...
    'state_1p3a.geojson': {
        ...
        tables: {
            ...
            testing:{
                csv: 'covid_testing_cdc_state',
                type: 'time-series-cumulative',
                accumulate: true,
                joinColumn: 'state_fips',
                dateList:'isoDateList'
            },
            testing_wk_pos:{
                csv: 'covid_wk_pos_cdc_state',
                type: 'time-series',
                joinColumn: 'state_fips',
                dateList:'isoDateList'
            },
            testing_tcap:{
                csv: 'covid_tcap_cdc_state',
                type: 'time-series',
                joinColumn: 'state_fips',
                dateList:'isoDateList'
            },
            testing_ccpt:{
                csv: 'covid_ccpt_cdc_state',
                type: 'time-series',
                joinColumn: 'state_fips',
                dateList:'isoDateList'
            },
            vaccinesAdmin1:{
                csv: 'vaccine_admin1_cdc',
                type: 'time-series',
                joinColumn: 'fips',
                dateList:'isoDateList'
            },
            vaccinesAdmin2:{
                csv: 'vaccine_admin2_cdc',
                type: 'time-series',
                joinColumn: 'fips',
                dateList:'isoDateList'
            },
            vaccinesDist:{
                csv: 'vaccine_dist_cdc',
                type: 'time-series',
                joinColumn: 'fips',
                dateList:'isoDateList'
            },
